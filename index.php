    ...
    <div class="header__inner">
      ...
      <nav class="nav" id="mainNav" aria-label="Navigasi Utama">
        <ul style="display:flex;align-items:center;gap:var(--space-1);list-style:none;margin:0;padding:0;">
          <!-- HOME -->
          <li class="nav__item">
            <a href="index" class="nav__link nav__link--active">HOME</a>
          </li>
  ...
  <section class="hero" id="hero">
    ...
    <div class="hero__content container">
      ...
      <div class="hero__actions">
        <a href="profil" class="btn btn--primary btn--lg">TENTANG KAMI</a>
  ...
  <section class="section packages reveal" id="paket-terbaru">
    <div class="container">
      ...
      <div class="packages__more">
        <a href="paket-wisata" class="btn btn--dark">VIEW MORE</a>
      </div>
    </div>
  </section>
  ...
  <section class="section blog reveal" id="blog">
    <div class="container">
      ...
      <div class="blog__grid">
        ...
        <article class="card blog-card reveal reveal--delay-1">
          ...
          <div class="card__body">
            ...
            <h3 class="card__title"><a href="blog-detail">10 Tips Packing Efisien untuk Liburan Panjang</a></h3>
      ...
      <div class="packages__more" style="margin-top:var(--space-12);">
        <a href="blog" class="btn btn--secondary">LIHAT SEMUA ARTIKEL</a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="footer__grid">
        ...
        <div class="footer__brand">
          ...
          <p class="footer__brand-text"><?php echo htmlspecialchars($profil['tentang_kami'] ?? 'Travel agent terpercaya di Surabaya sejak 2017. Menyediakan paket wisata domestik &amp; Asia, outbond, dan catering dengan layanan profesional dan harga terjangkau.'); ?></p>
