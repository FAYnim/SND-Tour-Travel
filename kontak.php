...
<head>
  ...
  <meta property="og:url" content="https://sndtour.com/kontak.html">
  ...
  <meta property="twitter:url" content="https://sndtour.com/kontak.html">
  ...
  <!-- Canonical -->
  <link rel="canonical" href="https://sndtour.com/kontak.html">
    ...
    <div class="header__inner">
      ...
      <nav class="nav" id="mainNav" aria-label="Navigasi Utama">
        <ul style="display:flex;align-items:center;gap:var(--space-1);list-style:none;margin:0;padding:0;">
          ...
          <!-- KONTAK (Active) -->
          <li class="nav__item">
            <a href="kontak.html" class="nav__link nav__link--active">KONTAK</a>
          </li>
        </ul>
      </nav>
        ...
        <div class="reveal reveal--left">
          ...
          <div class="contact-info__item">
            ...
            <div>
              ...
              <a href="https://wa.me/6281234567890" class="contact-info__value" target="_blank" rel="noopener noreferrer" style="color:var(--teal-dark);text-decoration:none;">+62 812-3456-7890</a>
            </div>
          </div>
          ...
          <div style="display:flex;gap:var(--space-4);margin-top:var(--space-8);flex-wrap:wrap;">
            <a href="https://wa.me/6281234567890?text=Halo%20SnD%20Tour%2C%20saya%20ingin%20bertanya%20tentang%20paket%20wisata" class="btn btn--primary" target="_blank" rel="noopener noreferrer">
